...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2 and sys.argv[1] == "-default":
        ...
        prec_pos, rec_pos, true_pos, false_pos, false_neg, true_neg = NaivBayesClassifier.prec_rec(evaluation_labels, guessedLabels, 'pos')
        print("true_pos, false_pos, false_neg, true_neg for 'pos' label:",true_pos, false_pos, false_neg, true_neg)

        prec_neg, rec_neg, true_pos, false_pos, false_neg, true_neg = NaivBayesClassifier.prec_rec(evaluation_labels, guessedLabels, 'neg')
        print("true_pos, false_pos, false_neg, true_neg for 'neg' label:",true_pos, false_pos, false_neg, true_neg)
        ...
        test_doc, test_label = NaivBayesClassifier.read_Document(sys.argv[2])
        guessedLabels = NaivBayesClassifier.classify_documents(test_doc, trainedData, label_probability)
        print("Overall Accuracy = ", NaivBayesClassifier.accuracy(test_label, guessedLabels))

        print('Accuracy of detecting a positive class:', NaivBayesClassifier.accuracyOfClassDetection(test_label, guessedLabels, 'pos'))
        print('Accuracy of detecting a negative class:', NaivBayesClassifier.accuracyOfClassDetection(test_label, guessedLabels, 'neg'))

        prec_pos, rec_pos, true_pos, false_pos, false_neg, true_neg = NaivBayesClassifier.prec_rec(test_label, guessedLabels, 'pos')
        print("true_pos, false_pos, false_neg, true_neg for 'pos' label:",true_pos, false_pos, false_neg, true_neg)

        prec_neg, rec_neg, true_pos, false_pos, false_neg, true_neg = NaivBayesClassifier.prec_rec(test_label, guessedLabels, 'neg')
        print("true_pos, false_pos, false_neg, true_neg for 'neg' label:",true_pos, false_pos, false_neg, true_neg)
